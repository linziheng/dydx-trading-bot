            ...
            if abs(z_score) >= ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    if check_base and check_quote:
                        ...
                        print(f"Balance: {free_collateral} and mininum at {USD_MIN_COLLATERAL}")
                        ...
                        print("bot_open_dict", bot_open_dict)
                        print(1)
                        ...
                        if bot_open_dict is not None and bot_open_dict["pair_status"] == "LIVE":
